class Admin::ProductsController < Admin::AdminController
  ...
  def create
    ...
    if @product.save
      flash[:notice] = t('admin.products.products.product_saved')
  ...
  def update
    ...
    if @product.update(product_params)
      flash[:notice] = t('admin.products.products.product_updated')
      redirect_to admin_product_path(@product)
    else
      render 'show'
    end
  ...
  def destroy
    if @product.destroy!
      flash[:notice] = t('admin.products.products.product_deleted')
  ...
  def clone
    ...
    if @product.save!
      flash[:notice] = t('admin.products.products.product_cloned')
      redirect_to admin_product_path(@product)
    end
  end
